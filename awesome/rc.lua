...
thermwidget = require("widgets/thermwidget")

batwidget = require("widgets/batwidget")

wifiwidget = require("widgets/wifiwidget")

memwidget = require("widgets/memwidget")
